...
log_file = open("cmd_log_base-10.txt", "a")
...
if __name__ == '__main__':
    ...
    common_voice = common_voice.map(prepare_dataset, fn_kwargs={'feature_extractor': feature_extractor, 'tokenizer': tokenizer}, remove_columns=common_voice.column_names["train"], num_proc=31)
    ...
    training_args = Seq2SeqTrainingArguments(
        output_dir="./LMT2-Base-10",  # change to a repo name of your choice
    ...
    kwargs = {
        "dataset_tags": "asr, speech-to-text, lmt2, tesseract3d, whisper-base, mozilla, common-voice, en",
        "dataset": "Common Voice 13.0",
        "dataset_args": "config: en, split: test",
        "language": "en",
        "model_name": "Tesseract3D/LMT2-base",  
